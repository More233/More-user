...
class CupertinoSegmentedControlPlatformView: NSObject, FlutterPlatformView {
  ...
  init(frame: CGRect, viewId: Int64, args: Any?, messenger: FlutterBinaryMessenger) {
    ...
    if #available(iOS 13.0, *), let c = tint {
      ...
      control.setTitleTextAttributes([.foregroundColor: UIColor.white, .font: UIFont.systemFont(ofSize: 13, weight: .bold)], for: .selected)
      control.setTitleTextAttributes([.foregroundColor: UIColor(red: 0.43, green: 0.43, blue: 0.45, alpha: 1.0), .font: UIFont.systemFont(ofSize: 13, weight: .semibold)], for: .normal)
    }
      ...
      case "setStyle":
        if let args = call.arguments as? [String: Any] {
          if #available(iOS 13.0, *), let n = args["tint"] as? NSNumber {
            ...
            self.control.setTitleTextAttributes([.foregroundColor: UIColor.white, .font: UIFont.systemFont(ofSize: 13, weight: .bold)], for: .selected)
            self.control.setTitleTextAttributes([.foregroundColor: UIColor(red: 0.43, green: 0.43, blue: 0.45, alpha: 1.0), .font: UIFont.systemFont(ofSize: 13, weight: .semibold)], for: .normal)
          }
