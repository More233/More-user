...
class _ConversationScreenState extends State<ConversationScreen> {
  ...
  Future<void> _handleCameraTap() async {
    await _processImagePick(ImageSource.camera);
  }

  Future<void> _handleGalleryTap() async {
    await _processImagePick(ImageSource.gallery);
  }
  ...
  Future<void> _processImagePick(ImageSource source) async {
    try {
      ...
      if (mounted) {
        ...
        } else if (errorString.contains("photo_access_denied") || errorString.contains("photo") || errorString.contains("gallery") || errorString.contains("permission")) {
