...
import 'save_to_list_bottom_sheet.dart';
...
class _CollectionDetailsScreenState extends State<CollectionDetailsScreen> {
  ...
  Future<void> _loadPosts() async {
    ...
    try {
      ...
      final col = manager.collections.firstWhere(
            ...
            children: [
              ...
              InkWell(
                onTap: () {
                  ...
                  CollectionsManager().removeCollection(widget.collectionId);
  ...
  Widget build(BuildContext context) {
    final col = CollectionsManager().collections.firstWhere(
      (c) => c.id == widget.collectionId,
      orElse: () => CollectionModel(id: '', name: '', postIds: []),
    );
              ...
              InkWell(
                onTap: () async {
                  ...
                  if (isSavedCollection) {
                    ...
                    await CollectionsManager().removePostFromCollection(col.id, post.id);
                    await CollectionsManager().removePostFromAllCollections(post.id);
                  } else {
                    await CollectionsManager().removePostFromCollection(widget.collectionId, post.id);
                    bool inOther = false;
                    for (final c in CollectionsManager().collections) {
