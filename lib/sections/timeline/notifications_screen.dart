  ...
  final List<Map<String, dynamic>> _activities = [
    {
      'type': 'like',
      'username': 'karennne',
      'avatar': 'assets/Timeline Phase need to rename/Timeline Section  Personal Timeline  Default State/image/Element.png',
      'text': 'liked your photo.',
      'time': '1h',
      'photo': 'assets/Timeline Phase need to rename/Timeline Section  Personal Timeline  Default State/image/sa.png',
    },
    {
      'type': 'like_multiple',
