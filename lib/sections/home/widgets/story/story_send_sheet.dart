...
class StorySendSheetContent extends ConsumerWidget {
  ...
  const StorySendSheetContent({super.key, required this.onDismissed});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final state = ref.watch(storySendFriendsProvider);
    final notifier = ref.read(storySendFriendsProvider.notifier);
